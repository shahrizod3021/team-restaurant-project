...
export const Aksiya = () => {
    ...
    const onOffAction = async (id) => {
        try {
            const res = await axios.put(BASE_URL + Apis.sale + "/" + id)
    ...
    const uploadSalePhoto = async () => {
        ...
        toast.dark(res.data.message, {position: toast.POSITION.TOP_CENTER})
        await getSale()
    }
                                            ...
                                            <div className="col-9">
                                                <div className={"d-flex align-items-center"}>
                                                    ...
                                                    <div className={"d-flex align-items-center justify-content-center"}>
                                                        <h5 className={"text-success"}>{item.foyiz}%</h5>
                                                        <img className={"col-10"} src={rasm} alt="" height={"35vh"}/>
                                                    </div>
                                                ...
                                                <div className={"card-footer form-check form-switch "}>
                                                    {item.active === false ? (
                                                        <>
                                                            <input value={onOff}
                                                                   onClick={() => setOnOff(true)}

                                                                   onChange={() => onOffAction(item.id)}
                                                        ...
                                                        <>
                                                            <input value={onOff}
                                                                   ...
                                                                   type="checkbox"
                                                                   role="switch"
                                                                   id="flexSwitchCheckDefault" checked={true}/>
                                                        </>
                                                    )}
                                                    {item.active ? (
                                                            <>
                                                        ...
                                                        (
                                                            <>
                                                                <p className={"text-light"}>not active</p>
                                                            </>
                                                        )
                                                    }
                                                </div>
